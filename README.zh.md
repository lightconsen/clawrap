<p align="center">
  <img src="assets/logo.png" alt="Clawrap Logo" height="80" />
</p>

<h1 align="center">Clawrap</h1>

<p align="center">
  <strong>开启 OpenClaw 的最简单方式</strong>
</p>

<p align="center">
  <a href="https://github.com/lightconsen/clawrap/actions/workflows/build.yml"><img src="https://img.shields.io/github/actions/workflow/status/lightconsen/clawrap/build.yml?branch=main" alt="构建状态" /></a>
  <a href="https://github.com/lightconsen/clawrap/releases"><img src="https://img.shields.io/github/v/release/lightconsen/clawrap" alt="最新版本" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/lightconsen/clawrap" alt="许可证" /></a>
</p>
...
- **故障排除**: 查看 [docs/troubleshooting.md](docs/troubleshooting.md)
